    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-bordered" style="padding-bottom:5px;">
                ...
                <div class="panel-body" style="border-top:0;padding-top:0px;">
                    @foreach ($products as $product)
                    <ul class="list-unstyled">
                        <li>Proudct ID : {{$product->id}}</li>
                        <li>Proudct Name : {{$product->name}}</li>
                        <li>Proudct Price : {{$product->presentPrice()}}</li>
                        <li>Proudct Quantity : {{$product->pivot->quantity}}</li>
                    </ul>
                    @endforeach
                </div>
                <!-- form start -->
